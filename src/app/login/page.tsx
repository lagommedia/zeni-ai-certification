...
const ERROR_MESSAGES: Record<string, string> = {
  domain: "Only @zeni.ai Google accounts can sign in to this app.",
    ...
    <div className="flex min-h-svh flex-col items-center justify-center bg-background px-4 py-12">
      <div className="mb-10 flex flex-col items-center gap-3 text-center">
        <div className="flex items-center gap-2.5">
          ...
          <span className="rounded-full border border-border px-2.5 py-0.5 text-xs font-semibold text-hero">
            Certification
          </span>
        </div>
        <h1 className="text-h4 font-medium text-sapphire">Sign in to keep learning</h1>
        <p className="max-w-sm text-sm text-muted-foreground">
          Sign in with your Zeni Google Workspace account to continue.
        </p>
      </div>
